...
> **Skill version:** 1.3.0 · updated 2026-08-17. Adds routing for delivery/package labels alongside TRS workflows.
...
| Delivery/package labels with dates or parentheses, folders, "what is in this drop" | **`synergy-trs-workflows`** |
...
|---|---|---|
| synergy-core | 1.3.0 | Rational Synergy 7.2 / 7.2.1 |